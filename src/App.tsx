            ...
            <section className="rounded-lg border bg-card">
              ...
              <div className="p-4">
                <nav className="flex flex-col gap-1">
                  {[
                    { description: "Pivo", amount: "300 Kč" },
                    { description: "Oběd", amount: "150 Kč" },
                    { description: "Lidl", amount: "1200 Kč" },
                    { description: "Koncert", amount: "600 Kč" },
                  ].map((item) => (
                    <div className="text-left rounded-md px-3 py-2">
                    ...
                    <Field>
                        <FieldContent>
                            <select className="h-10 w-full rounded-md border bg-background px-3 text-sm">
                                <option value="neco">Potraviny</option>
                                <option value="dalsi">Pití</option>
                            </select>
                        </FieldContent>
                    </Field>
                  <Field orientation="responsive">
